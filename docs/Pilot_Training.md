...
1. Sign in (optional **English / Hinglish** on the login screen, or translate icon on home) → confirm active project (switcher at top). Field chrome (home through Voice notes, plus Documents status / DPR blockers / Site ops snackbars) follows the selected language.
