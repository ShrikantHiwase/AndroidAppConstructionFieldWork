...
1. Sign in (optional **English / Hinglish** on the login screen, or translate icon on home) → confirm active project (switcher at top). Home, Sync status, Digests/Reminders, Issues/RFI/DPR, Site ops, Documents/pins, Pilot, Weekly progress, and Admin invites chrome follow the selected language.
